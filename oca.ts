...
import { hashCode, hashToRGBA } from './utils/screen.utils'
...
export interface OCABundleResolver {
  getCredentialPresentationFields(credential: CredentialExchangeRecord, language: string): Promise<Field[] | undefined>
...
export class DefaultOCABundleResolver implements OCABundleResolver {
  ...
  public resolve(credential: CredentialExchangeRecord): Promise<OCACredentialBundle | undefined> {
    ...
    //tzTU3gw6xGsWXYUdMkjjb:3:CL:27618:ontario-test-credential
